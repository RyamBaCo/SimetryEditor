...
{
    public class ActionSpawnTriangle : BaseAction
    {
        ...
        public ActionSpawnTriangle(bool executeOnEnter, bool executeOnExit, bool executeOnKey, string parameters)
            :   base(executeOnEnter, executeOnExit, executeOnKey)
        {
            Abortable = false;

            ActionValue = new SerializationConstants.ActionValue(SerializationConstants.ACTION_SPAWN_TRIANGLE);
        ...
        public override void Execute()
        {
            ...
            if (gameObject.OnSpawnTriangle != null)
                gameObject.OnSpawnTriangle(State, targetPosition);
